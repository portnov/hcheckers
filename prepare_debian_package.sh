...
tar -v -cJ --exclude-vcs --exclude='*.log' --exclude='*.build' --exclude=./.stack-work --exclude=./debian --exclude=./docker --exclude=./csv --exclude=./games --exclude=./python --exclude=./test --exclude='*.tar.xz' -f ../$TARGET .
